                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                    	 <div class="modal-body-left">
                            ...
                            <input type="text" placeholder="Giới thiệu sản phẩm" name="Descripsion" class="form-control my-3 p-4">
                            <p>Giá sản phẩm</p>
                            <input type="text" placeholder="Giá sản phẩm" name="Price" class="form-control my-3 p-4">
                            <p>Ảnh đại diện sản phẩm</p>
                            <input type="text" placeholder="Link ảnh đại diện" name="Img_cover" class="form-control my-3 p-4">
                            <p>Ảnh phụ đại diện sản phẩm</p>
                            <input type="text" placeholder="Link ảnh phụ" name="Img_hover" class="form-control my-3 p-4">
                            <p>Nhà sản xuất</p>
                          ...
                          <div class="modal-body-left">
                              ...
                              <input type="text" placeholder="Link ảnh chi tiết thứ nhất" name="Img_detail1" class="form-control my-3 p-4">
                              <p>Ảnh chi tiết thứ hai sản phẩm</p>
                              <input type="text" placeholder="Link ảnh chi tiết thứ hai" name="Img_detail2" class="form-control my-3 p-4">
                              <p>Ảnh chi tiết thứ ba sản phẩm</p>
                              <input type="text" placeholder="Link ảnh chi tiết thứ ba" name="Img_detail3" class="form-control my-3 p-4">
                              <p>Ảnh chi tiết thứ tư sản phẩm</p>
                              <input type="text" placeholder="Link ảnh chi tiết thứ tư" name="Img_detail4" class="form-control my-3 p-4">
                              <p>Số lượng</p>
                              <input type="text" placeholder="Link ảnh chi tiết thứ tư" name="Img_detail5" class="form-control my-3 p-4">
                              <p>Loại sản phẩm</p>
