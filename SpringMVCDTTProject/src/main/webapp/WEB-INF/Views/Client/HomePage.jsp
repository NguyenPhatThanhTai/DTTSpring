		...
		<div class="slider">
			<div class="container">
				...
				<div class="slide active">
					<div class="info">
						<div class="info-content">
							<h3 class="top-down">BAG CAROL PINK</h3>
							<h2 class="top-down trans-delay-0-2">Next-gen design</h2>
							<p class="top-down trans-delay-0-4">Sản phẩm phù hợp cho giới
								trẻ. Màu sắc cá tính, trẻ trung cùng với thiết kế đậm chất tươi
								mới. Khiến cho nhiều anh em phải ngước nhìn.</p>
				...
				<div class="slide">
					<div class="info">
						<div class="info-content">
							<h3 class="top-down">BAG TUNE HORIZON</h3>
							<h2 class="top-down trans-delay-0-2">New trending</h2>
							<p class="top-down trans-delay-0-4">Sản phẩm phù hợp cho giới
								trẻ. Màu sắc cá tính, trẻ trung cùng với thiết kế đậm chất tươi
								mới. Khiến cho nhiều anh em phải ngước nhìn.</p>
							<div class="top-down trans-delay-0-6">
				...
				<div class="slide">
					<div class="info">
						<div class="info-content">
							<h3 class="top-down">BAG YOUNG YELLOW</h3>
							<h2 class="top-down trans-delay-0-2">Simple is good</h2>
							<p class="top-down trans-delay-0-4">Sản phẩm phù hợp cho giới
								trẻ. Màu sắc cá tính, trẻ trung cùng với thiết kế đậm chất tươi
								mới. Khiến cho nhiều anh em phải ngước nhìn.</p>
							<div class="top-down trans-delay-0-6">
		...
		<div class="row">
			...
			<div class="col-4 col-md-12 col-sm-12">
				<div class="promotion-box">
					...
					<img
						src="<c:url value="/resources/IMG/tuixachfgd_ccexpress.png" />"
						alt="">
				</div>
			</div>
			<div class="col-4 col-md-12 col-sm-12">
				<div class="promotion-box">
					...
					<img src="<c:url value="/resources/IMG/bagrmbg_removebg.png" />"
						alt="">
				</div>
			</div>
		</div>
	...
	<div class="section">
		<div class="container">
			...
			<div class="row" id="latest-products">
				...
				<c:forEach var="item" items="${list_product_recomment}"
					varStatus="status">
							...
							<div class="product-card-info">
								<div class="product-btn">
									...
									<button class="btn-flat btn-hover btn-shop-now">
										<a href="Detail-Product/${item.id}">xem ngay</a>
									</button>
								...
								<div class="product-card-name">${item.productDetail.name}
								</div>
			...
			<div class="section-footer">
				<a href="All-Products?offset=1" class="btn-flat btn-hover">xem
					tất cả</a>
			</div>
		</div>
	</div>
			...
			<div class="row">
				...
				<div class="col-7 col-md-8">
					<div class="sp-item-info">
						...
						<p class="sp-item-description">Sản phẩm phù hợp cho giới trẻ.
	...
	<div class="section">
		<div class="container">
			...
			<div class="row" id="best-products">
				<c:forEach var="item" items="${list_bestSeller_product}"
					varStatus="status">
					<div class="col-3 col-md-6 col-sm-12">
						<div class="product-card">
							<div class="product-card-img">
							...
							<div class="product-card-info">
								<div class="product-btn">
									<button class="btn-flat btn-hover btn-shop-now">xem
										ngay</button>
									<button class="btn-flat btn-hover btn-cart-add">
	...
	<div class="section">
		<div class="container">
			...
			<div class="blog">
				...
				<div class="blog-info">
					<div class="blog-title">Sản phẩm bán chạy nhất tháng 3</div>
					<div class="blog-preview">Sản phẩm phù hợp cho giới trẻ. Màu
						sắc cá tính, trẻ trung cùng với thiết kế đậm chất tươi mới. Khiến
						cho nhiều anh em phải ngước nhìn.</div>
			...
			<div class="blog row-revere">
				...
				<div class="blog-info">
					<div class="blog-title">Sản phẩm nổi bật tháng 4</div>
					<div class="blog-preview">Sản phẩm phù hợp cho giới trẻ. Màu
						sắc cá tính, trẻ trung cùng với thiết kế đậm chất tươi mới. Khiến
						cho nhiều anh em phải ngước nhìn.</div>
					<button class="btn-flat btn-hover">đọc tiếp</button>
