			...
			<ul class="list-group mb-3">
				<c:forEach var="item" items="${list_cart}" varStatus="status">
					<li class="list-group-item d-flex justify-content-between lh-sm">
						...
						</div> <span class="text-muted">${(item.price) * (item.number)}
							VND</span>
					</li>
				</c:forEach>
			</ul>
				...
				<div class="row g-3">
					<div class="col-sm-6">
						<label for="firstName" class="form-label">Họ</label> <input
							...
							placeholder="Họ của bạn" value="" required="">
					...
					<div class="col-sm-6">
						<label for="lastName" class="form-label">Tên</label> <input
							...
							placeholder="Tên của bạn" value="" required="">
					...
					<div class="col-12">
						<label for="address" class="form-label">Địa chỉ</label> <input
							...
							placeholder="123/2 Võ Thị Sáu..." required="">
