		...
		<div class="header-wrapper" id="header-wrapper">
			...
			<div class="bg-second">
				<div class="top-header container">
					<ul class="devided">
						<li><a href="#">+84345439899</a></li>
						<li><a href="#">dttstore@gmail.com</a></li>
					</ul>
					<ul class="devided">
						<li class="dropdown"><a href="">VND</a> <i
						...
						<li class="dropdown"><a href="">TIẾNG VIỆT</a> <i
							class='bx bxs-chevron-down'></i>
							<ul class="dropdown-content">
			...
			<div class="bg-second">
				<div class="bottom-header container">
					<ul class="main-menu">
						...
						<!-- mega menu -->
						<li class="mega-dropdown"><a href="./products.html">danh
								mục<i class='bx bxs-chevron-down'></i>
						</a>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-3 col-md-6 col-sm-12">
					<div class="contact">
						<h3 class="contact-header">DTT Store</h3>
